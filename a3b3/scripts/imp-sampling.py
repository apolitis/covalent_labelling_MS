...
def create_representation():
    ...
    def create_protein_from_pdbs(name, files):
        def create_from_pdb(file):
            ...
            datadir = '/u/cvr/apolitis/docs-imp/CovalentLabelling/benchAB-complete/'
...
#            return c
    ...
    create_protein_from_pdbs("A", ["AB-1.pdb"])
    create_protein_from_pdbs("B", ["AB-2.pdb"])
    create_protein_from_pdbs("C", ["AB-3.pdb"])
...
def create_restraints(m, all):
    def add_connectivity_restraint(s):
        ...
        iB = r.add_type([rps[1]])
        iC = r.add_type([rps[2]])
        n1 = r.add_composite([iA, iB, iC])
        n2 = r.add_composite([iA, iB], n1)
        n3 = r.add_composite([iA, iC], n1)
        n4 = r.add_composite([iB, iC], n1)
    ...
    add_connectivity_restraint([sA, sB, sC])
...
f1 = open("creteNative-out_MSscores-completeAB.csv", "w")
